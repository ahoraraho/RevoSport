        ...
        <div class="span12">
          <div class="widget-box">
            ...
            ?>
                    ...
                    <table class="table table-bordered table-invoice-full">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <div class="text-center"><?php echo $row['direccion']; ?></div>
                          </td>
                          <td>
                            <div class="text-center"><?php echo '$' . $row['cantidad']; ?></div>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td class="msg-invoice" width="55%">
                            <div class="text-center">
                              <h4>Last Payment Done: $<?php echo $row['cantidad']; ?>/-</h4>
                              <em><a href="#" class="tip-bottom" title="Registration Date" style="font-size:15px;">Member Since: <?php echo $row['ingreso']; ?> </a></em>
                          </td>
                  </div>
                  </tr>
                  </tbody>
              ...
              <div class="row-fluid">
                <div class="pull-left">
                  <h4>Member <?php echo $row['nombrecompleto']; ?>,<br /> <br /> Membership is currently <?php echo $row['estado']; ?>! <br /></h4>
