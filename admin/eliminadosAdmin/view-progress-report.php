              ...
              <div class="widget-content">
                    ...
                    <table class="table table-bordered table-invoice-full">
                      <thead>
                        <tr>
                          ...
                          <th class="head1">servicios Taken</th>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <div class="text-center"><?php echo $row['servicios']; ?></div>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td class="msg-invoice" width="55%">
                            <div class="text-center">
                              <h5><?php echo $row['nombrecompleto']; ?>'s Body Structure stated as from <?php echo $row['ini_bodytype']; ?> to <?php echo $row['curr_bodytype']; ?>. <br /> With Total Weight Differences of <?php include 'actions/weight-diff.php'; ?> KG <br /> As per records of <?php echo $row['progress_date']; ?></h5>
                ...
                <div class="row-fluid">
                  <div class="pull-left">
                    ...
                    <h4>GYM Member: <?php echo $row['nombrecompleto']; ?> <br> Weight Variation of <em style="color:green"><?php include 'actions/progress-percent.php'; ?>%</em> as per current updates! <i class="fa fa-spinner fa-spin" style="font-size:24px"></i><br /> <br /> <br /></h4>
                    <p>Thank you for choosing our servicios.<br />- on the behalf of whole team</p>
                  </div>
