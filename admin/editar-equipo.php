...
<div id="content">
  ...
  <div id="breadcrumb"> <a href="index.php" title="Ir a inicio" class="tip-bottom"><i class="fas fa-home"></i> Inicio </a> <a href="#" class="current"> Gestionar equipos</a> <a href="#" class="current">Editar equipos</a> </div>
        ...
        $result=mysqli_query($conn,$qry);
          ...
          echo"<table class='table table-bordered table-hover'>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'><a href='editar-equipos-form.php?id=".$row['id']."'><i class='fas fa-edit'></i> Editar </a></div></td>
