...
<body>
  ...
  <div id="content">
    <div id="content-header">
      <div id="breadcrumb"> <a href="index.php" title="Ir a inicio" class="tip-bottom"><i class="fas fa-home"></i> Inicio </a> <a href="#" class="current"> Gestionar equipos</a><a href="eliminar-equipo.php" class="current">Eliminar equipo</a> </div>
      <h1 class="text-center">Eliminar equipos registrados <i class="fas fa-cogs"></i></h1>
    </div>
          ...
          <div class='widget-box'>
            ...
            <div class='widget-content nopadding'>
              ...
              while ($row = mysqli_fetch_array($result)) {
                ...
                <td><div class='text-center'><a href='actions/borrar-equipo.php?id=" . $row['id'] . "' style='color:#F66;'><i class='fas fa-trash'></i> Eliminar </a></div></td>
