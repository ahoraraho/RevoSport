...
<body>
  ...
  <div id="content">
    <div id="content-header">
      <div id="breadcrumb"> <a href="index.php" title="Ir a inicio" class="tip-bottom"><i class="fas fa-home"></i> Inicio </a> <a href="#" class="current"> Gestionar equipos</a> <a href="#" class="current">Lista de equipos</a> </div>
      <h1 class="text-center">Lista de equipos registrados <i class="fas fa-cogs"></i></h1>
    </div>
